...
public class MyCalc extends JFrame implements ActionListener {
	private static final long serialVersionUID = 946347660597617917L;
	private JButton bOne, bTwo, bThree, bFour, bFive, bSix, bSeven, bEight,
			bNine, bZero, bExit, bMult, bDiv, bSub, bPlus, bCEnt, bCAll,
			bEquals, bPlusMinus, bExp, bMPlus, bMMinus, bFact, bOneDivX, bSqrt,
			bDecPt;
	...
	private boolean myDiag = false, result = true, firstNumSet = false,
			secondNumSet = false, pendingOp = false;
	private double dNum1 = 0.0, dNum2 = 0.0, answer = 0.0, minusOne = -1.0;
	private double dArray[] = new double[10];
	private int opCode = -1, tempInt = 0, tempInt2 = 0, dArrayPtr = 0,
			pendingOpCode = -1;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == bDecPt) {
			...
			MyPrint("The zero button was pressed. And pendingOp is "
					+ pendingOp);
			...
			MyPrint("The Three button was pressed. And pendingOp is "
					+ pendingOp);
			enterBox.setText(enterBox.getText() + "3");
		} else if (e.getSource() == bFour) {
			MyPrint("The Four button was pressed. And pendingOp is "
					+ pendingOp);
			enterBox.setText(enterBox.getText() + "4");
		} else if (e.getSource() == bFive) {
			MyPrint("The Five button was pressed. And pendingOp is "
					+ pendingOp);
			...
			MyPrint("The Seven button was pressed. And pendingOp is "
					+ pendingOp);
			enterBox.setText(enterBox.getText() + "7");
		} else if (e.getSource() == bEight) {
			MyPrint("The Eight button was pressed. And pendingOp is "
					+ pendingOp);
			enterBox.setText(enterBox.getText() + "8");
		} else if (e.getSource() == bNine) {
			MyPrint("The Nine button was pressed. And pendingOp is "
					+ pendingOp);
			enterBox.setText(enterBox.getText() + "9");
		} else if (e.getSource() == bExit) {
			dispose();
		} else if (e.getSource() == bMult) {
			MyPrint("The Mult button was pressed. And pendingOp is "
					+ pendingOp);
			multOp();
			...
			MyPrint("The Plus button was pressed. And pendingOp is "
					+ pendingOp);
			plusOp();
			...
			MyPrint("The bSqrt button was pressed. And pendingOp is "
					+ pendingOp);

			MySqrt();
		} else if (e.getSource() == bOneDivX) {
			MyPrint("The bOneDivX button was pressed. And pendingOp is "
					+ pendingOp);
			OneDivX();
			...
			MyPrint("The Equals button was pressed. And pendingOp is "
					+ pendingOp + " The opCode value is " + opCode);
			...
			MyPrint("1a: The MPlus button was pressed. pendingOp =s "
					+ pendingOp);
			if (dArrayPtr < 10) {
				/** array hold 10 entries */
				if (!pendingOp) {
					if (opCode == 99) {
						// enterBox.setText( "" );
						MyPrint("1b: The value of opCode is " + opCode
								+ " firstNum =s " + firstNum + " answer =s "
								+ answer);
						pendingOpCode = -1;
						firstNumSet = true;
						firstNum = "" + answer;
						dArray[dArrayPtr] = Double.parseDouble("" + answer);
						dArrayPtr++;
						enterBox.setText(firstNum);
						MyPrint("1c: The value of dArrayPtr is " + dArrayPtr);
					} else {
						/**
						 * This code is entered if the =s button was not just
						 * pressed
						 */
						firstNum = "" + enterBox.getText();
						firstNumSet = true;
						dArray[dArrayPtr] = Double.parseDouble("" + firstNum);
						dArrayPtr++;
						MyPrint("1d: The value of dArrayPtr is " + dArrayPtr);
					}
				} else if (!enterBox.getText().equals("")) {
					dArray[dArrayPtr] = Double.parseDouble(enterBox.getText());
					dArrayPtr++;
					firstNumSet = true;
					firstNum = "" + answer;
					MyPrint("1d: The value of dArrayPtr is " + dArrayPtr);
					...
					JOptionPane
							.showMessageDialog(
									this,
									"A number must be entered befor clicking the M+ button",
			...
			if (dArrayPtr > 0) {
				...
				JOptionPane.showMessageDialog(this,
						"There are no more values to retrieve using M-.",
						"No More Values.", JOptionPane.ERROR_MESSAGE);
			}
			...
			MyPrint("1a- bFact(): opCode is " + opCode + " firstNum is "
					+ firstNum);
			if (opCode == 99) {
				tempInt = (int) answer;
			} else if (!enterBox.getText().equals("")) {
				MyPrint("1b- bFact(): The value of enterBox.getText() is "
						+ enterBox.getText());
	...
	private void opCodeMethod() {
		...
		case 4:
			...
			MyPrint("Case 4: the value of firstNum is " + firstNum
	...
	private void multOp() {
		...
		if (pendingOp) {
			MyPrint("1a- multOp(): opCode is " + opCode
		...
		if (!firstNumSet) {
			...
			if (opCode == 99) {
				firstNum = "" + answer;
				firstNumSet = true;
				MyPrint("1b- multOp(): opCode is " + opCode
						+ " The value of firstNum is " + firstNum);
			}

			if (checkFirstNum()) {
				opCode = 0;
				MyPrint("1c- multOp(): opCode is " + opCode
						+ " The value of firstNum is " + firstNum);
				pendingOpCode = 0;
			}
		} else if (opCode == 0) {
			...
			secondNum = enterBox.getText();
			pendingOp = true;
			MyPrint("2a- multOp(): opCode is " + opCode
					+ " The value of secondNum is " + secondNum);
			if (secondNum.equals("")) {
				secondNum = "1.0";
				MyPrint("2b- multOp(): opCode is " + opCode
						+ " The value of secondNum is " + secondNum);
			}
			MyPrint("3a- multOp(): opCode is " + opCode + " secondNum is "
					+ secondNum);
			convertNumsToDouble();
			answer = dNum1 * dNum2;
			setResults();
			MyPrint("3b- multOp(): opCode is " + opCode
					+ " The value of answer is " + answer);
			dNum1 = answer;
			secondNum = "0.0";
			secondNumSet = true;
			...
			opCode = 0;
			result = true;
			MyPrint("3a- multOp(): opCode is " + opCode
					+ " The value of answer is " + answer);
		}
	}

	private void divOp() {
		MyPrint("1a- divOp(): opCode is " + opCode + " firstNumSet =s "
				+ firstNumSet);
		if (pendingOp) {
		...
		if (!firstNumSet) {
			...
			if (opCode == 99) {
				firstNum = "" + answer;
				firstNumSet = true;
				MyPrint("1b- divOp(): opCode is " + opCode
						+ " The value of firstNum is " + firstNum);
			}

			if (checkFirstNum()) {
				MyPrint("1c- divOp(): opCode is " + opCode
						+ " The value of firstNum is " + firstNum);
				pendingOpCode = 1;
				opCode = 1;
			}
			...
			if (secondNum.equals("") || opCode < 0) {
				...
				if (dNum2 != 0.0) {
					...
					JOptionPane.showMessageDialog(this, "The number " + dNum2
							+ " cannot be used as a denometer",
	...
	private void subOp() {
		...
		if (pendingOp) {
			MyPrint("subOp() 1a: In pendingOp code. The opcode value is "
					+ opCode);
			opCodeMethod();
			opCode = 2;
			pendingOp = true;
			...
			firstNumSet = true;
			result = true;
			MyPrint("1b- subOp()-checkFirstNum(): opCode is " + opCode
					+ " The value of answer is " + answer);
		} else if (opCode == 2) {
			pendingOp = false;
			...
			MyPrint("2a- subOp(): opCode is " + opCode + " secondNum is "
					+ secondNum);
			convertNumsToDouble();
			answer = dNum1 - dNum2;
			setResults();
			MyPrint("2b- subOp(): opCode is " + opCode
					+ " The value of answer is " + answer);
			secondNum = "0.0";
			opCode = -1;
			secondNumSet = true;
			...
			opCode = 2;
			result = true;
			MyPrint("3a- subOp(): opCode is " + opCode
					+ " The value of answer is " + answer);
		}
	}
	...
	private void plusOp() {
		...
		if (pendingOp) {
			...
			firstNumSet = true;
			result = true;
			MyPrint("1b- plusOp()-checkFirstNum(): opCode is " + opCode
					+ " The value of answer is " + answer);
		} else if (opCode == 3) {
			pendingOp = false;
			MyPrint("2aa- plusOp(): opCode is " + opCode + " secondNum is "
					+ secondNum);
			if (secondNum.equals("0.0")) {
				firstNum = "" + answer;
			}
			...
			MyPrint("2a- plusOp(): opCode is " + opCode + " secondNum is "
					+ secondNum);
			convertNumsToDouble();
			answer = dNum1 + dNum2;
			setResults();
			MyPrint("2b- plusOp(): opCode is " + opCode
					+ " The value of answer is " + answer);
			secondNum = "0.0";
			opCode = -1;
			secondNumSet = true;
			...
			opCode = 3;
			result = true;
			MyPrint("3a- plusOp(): opCode is " + opCode
					+ " The value of answer is " + answer);
		}
	}
	...
	private void MySqrt() {
		MyPrint("1a- MySqrt(): opCode is " + opCode + " firstNum is "
				+ firstNum);
		if (opCode == 99) {
			answer = Math.sqrt(answer);
			setResults();
		} else if (!enterBox.getText().equals("")) {
			MyPrint("1b- MySqrt(): opCode is " + opCode + " firstNum is "
					+ firstNum);
			if (pendingOp)
				opCodeMethod();
			...
			MyPrint("1c- MySqrt(): opCode is " + opCode + " firstNum is "
					+ firstNum);
	...
	private void OneDivX() {
		MyPrint("1a- OneDivX(): opCode is " + opCode + " firstNum is "
				+ firstNum);
		if (opCode == 99) {
			answer = (1.0 / answer);
			setResults();
