...
public class fontSelector extends JFrame {
	private static final long serialVersionUID = 2320167796342035904L;
	Dimension screen = Toolkit.getDefaultToolkit().getScreenSize();
	String fontString[] = GraphicsEnvironment.getLocalGraphicsEnvironment()
			.getAvailableFontFamilyNames();
	JComboBox fontSelector = new JComboBox(fontString);
	JLabel fontLabel = new JLabel("Select Font");

	String fontSizeString[] = { "10", "12", "14", "16", "18", "20", "22", "24",
			"28" };
	...
	public fontSelector() {
		...
		fontSelector.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				preview.setFont(new Font(String.valueOf(fontSelector
						.getSelectedItem()), fontStyle.getSelectedIndex(), 14));
			}
		});
	...
	public Font returnFont() {
		...
		int fontSZ = Integer
				.parseInt(String.valueOf(fontSize.getSelectedItem()));
