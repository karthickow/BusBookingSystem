...
public class editor extends JFrame {
	private static final long serialVersionUID = 3590511536445142896L;
	...
	JButton newFile = new JButton(new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/newfile.png"));
	JButton openFile = new JButton(new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/open.png"));
	JButton saveFile = new JButton(new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/save.png"));

	JButton cutFile = new JButton(new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/cut.png"));
	JButton copyFile = new JButton(new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/copy.png"));
	JButton pasteFile = new JButton(new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/paste.png"));
	...
	JMenuItem NEWFILE = new JMenuItem("New", new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/newfile.png"));
	JMenuItem OPENFILE = new JMenuItem("Open", new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/open.png"));
	JMenuItem SAVEFILE = new JMenuItem("Save", new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/save.png"));
	...
	public editor() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (area.getText().equals("")) {
					...
					int confirm = JOptionPane.showConfirmDialog(null,
							"Would you like to save?", "New File",
		...
		SELECTEDIT.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A,
				ActionEvent.CTRL_MASK));
		...
		TIMEDIT.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String dd;
				formatter = new SimpleDateFormat("KK:mm aa MMMMMMMMM dd yyyy",
						Locale.getDefault());
		...
		EXITFILE.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int confirm = JOptionPane.showConfirmDialog(null,
						"Would you like to save?", "Exit Application",
						JOptionPane.YES_NO_CANCEL_OPTION);
		...
		GOTOEDIT.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Element paragraph = root.getElement(Integer
				...
				try {
					do {
						...
						if (nextLine != null) {
							...
							if (pg != null) {
								pg.setFont(typeface);
								pg.drawString(nextLine, margin, curHeight
										- fontDescent);
							}
						}
					} while (nextLine != null);
