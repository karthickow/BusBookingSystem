...
public class NewEntry extends javax.swing.JFrame {	
	private static final long serialVersionUID = 8203682257331209595L;
	...
	String getPicture;
	public NewEntry (String emp, String sname, String fname,String lname, String gender, String dob,String designation,String tele,String ema,String adres ){
		...
		lblEmplPic.setIcon(new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/"+ txtEmpNo.getText() +".jpg"));
		...
		Update.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (txtEmpNo.getText() == null ||
					...
					JOptionPane.showMessageDialog(null,"Enter Employee Number",Constants.ERROR
							,JOptionPane.ERROR_MESSAGE);
				...
				if (txtSname.getText() == null ||
					...
					JOptionPane.showMessageDialog(null,"Enter Employee Surname",Constants.ERROR,
							JOptionPane.ERROR_MESSAGE);
					txtSname.requestFocus();
					return;}
				if (txtFname.getText() == null ||
						txtFname.getText().equals("")){   
					JOptionPane.showMessageDialog(null,"Enter Employee First Name",Constants.ERROR,
							JOptionPane.ERROR_MESSAGE);
					txtFname.requestFocus();
					return;}
				if (txtLname.getText() == null ||
						txtLname.getText().equals("")){   
					JOptionPane.showMessageDialog(null,"Enter Employee Last Name",Constants.ERROR,
							JOptionPane.ERROR_MESSAGE);
