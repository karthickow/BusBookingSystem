...
public class Up_date_Pass extends JFrame{
	private static final long serialVersionUID = -1670176942808444704L;
	...
	public Up_date_Pass (String s1,String s2,String s3,String s4,String s5,String s6,String s7){
		...
		setCbx();
		button1=new JButton("UPDATE",new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/reset.png"));
		button2=new JButton("SEARCH",new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/search.png"));
		button3=new JButton("DELETE",new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/delete.png"));
		button4=new JButton("CLEAR",new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/exit.png"));
		button5=new JButton("CANCEL",new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/exit.png"));
			...
			public void focusLost(FocusEvent e) {
				...
				if (content.length() != 0) {
					try {
						...
						getToolkit().beep();
						JOptionPane.showMessageDialog(null,"Invalid data entry",Constants.ERROR,
		...
		button1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (text1.getText() == null ||
					...
					JOptionPane.showMessageDialog(null,"Enter Passenger number",Constants.ERROR
							,JOptionPane.ERROR_MESSAGE);
					text1.requestFocus();
					return;
				}
				if (text2.getText() == null ||
					...
					JOptionPane.showMessageDialog(null,"Enter passenger name",Constants.ERROR,
							JOptionPane.ERROR_MESSAGE);
					text2.requestFocus();
					return;}
				if (text3.getText() == null ||
						text3.getText().equals("")){   
					JOptionPane.showMessageDialog(null,"Address Field is required",Constants.ERROR,
							JOptionPane.ERROR_MESSAGE);
					text3.requestFocus();
					return;}
				if (text4.getText() == null ||
						text4.getText().equals("")){   
					JOptionPane.showMessageDialog(null,"Enter telephone number",Constants.ERROR,
							JOptionPane.ERROR_MESSAGE);
					text4.requestFocus();
					return;}
