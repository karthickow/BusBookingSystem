...
public class Passenger extends JFrame{
	private static final long serialVersionUID = -3743882896163821556L;
	...
	public Passenger(){
		...
		setCbx();
		button1=new JButton("ADD NEW", new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/addrecord.png"));
		button2=new JButton("CANCEL", new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/exit.png"));
		button3=new JButton("CLEAR", new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/exit.png"));
