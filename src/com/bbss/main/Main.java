...
public class Main extends JPanel implements Printable {
	...
	public Main() {
		...
		jButton4 = new JButton("PRINT", new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/prints.png"));
		...
		jButton4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				 ...
				 * pj.setPrintable(Main.this); pj.printDialog(); try{
				 * pj.print(); }catch (Exception PrintException) {}
				 */
		...
		jButton2.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				new UpdateEntry(jTable.getValueAt(getSelectedRow(), 0)
						.toString(), jTable.getValueAt(getSelectedRow(), 1)
						.toString(), jTable.getValueAt(getSelectedRow(), 2)
						.toString(), jTable.getValueAt(getSelectedRow(), 3)
						.toString(), jTable.getValueAt(getSelectedRow(), 4)
						.toString(), jTable.getValueAt(getSelectedRow(), 5)
						.toString(), jTable.getValueAt(getSelectedRow(), 6)
						.toString(), jTable.getValueAt(getSelectedRow(), 7)
	...
	public static int getSelectedRow() {
		...
		rowSel.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
			public void valueChanged(javax.swing.event.ListSelectionEvent e) {
				...
				javax.swing.ListSelectionModel sel = (ListSelectionModel) e
						.getSource();
