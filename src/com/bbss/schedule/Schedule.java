...
public class Schedule extends JFrame {
	private static final long serialVersionUID = 5166604678577110139L;
	...
	public Schedule () {
		...
		Check=new JButton("View Shedules",new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/select.png"));
		Schedule = new JButton("Schedule",new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/calendar.png"));
		//		Enable=new JButton ("Start",new ImageIcon(Constants.USER_DIR+"/src/com/bbss/images/contents.png"));
		...
		try
		{
			...
			if (recordfound)
			{
				...
				JOptionPane.showMessageDialog(null,"Either You are Trying Give a driver \n"+
						...
						"Drivers at the same time.",Constants.ERROR,JOptionPane.INFORMATION_MESSAGE);
				return;
			}
			else{
				try 
